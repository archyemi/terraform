...
type GraphWalker interface {
	...
	ExitEvalTree(dag.Vertex, interface{}, tfdiags.Diagnostics) tfdiags.Diagnostics
}
...
func (NullGraphWalker) ExitEvalTree(dag.Vertex, interface{}, tfdiags.Diagnostics) tfdiags.Diagnostics {
	return nil
}
